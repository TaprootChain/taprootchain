  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      iconSize: "18px",
      text: "Twitter",
      url: "https://x.com/taprootchain",
    },
    {
      icon: "discussions" as const,
      iconSize: "20px",
      text: "Telegram",
      url: "https://t.me/taprootchain",
    },
  ];
    ...
    (gridArea?: GridProps["gridArea"]) => {
      return (
        <Box gridArea={gridArea}>
          <Link fontSize="xs" href="https://taprootchain.io">
            Taprootchain.io
          </Link>
          <Text mt={3} fontSize="xs">
            Developed by @Taprootlabs , The First BTC Layer 2 for Crypto
            Application, Integrating Bitcoin, Smart Contract and Taproot Assets
          </Text>
